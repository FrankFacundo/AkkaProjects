...
public class FirstActor extends AbstractActor{
	...
	public void receiveFunction(MyMessage m){
		...
		MyMessage2 mymessage1 = new MyMessage2("First Message");
		MyMessage2 mymessage2 = new MyMessage2("Second Message");
		(this.actorRef).tell(mymessage1, getSelf());
		(this.actorRef).tell(mymessage2, getSelf());
	}
